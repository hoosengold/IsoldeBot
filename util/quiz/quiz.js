      ...
      try {
        ...
        for (let k = 1; k < quizArray.length; k++) {
          if (quizMessage === "") {
            ...
            quizMessage = `${quizMessage} ${emojiArray()[k - 1]} ${
              quizArray[k]
            } \n\n `;
          }
        }
        ...
        await db.query(
          "insert into quiz(counter, question, options) values ($1, $2, $3)",
          [quizCounter, quizArray[0], quizOptions]
        );
