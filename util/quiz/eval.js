          ...
          if (args.length === 0) {
            ...
            for (let i = 0; i < mostCorrectAnswers.length; i++) {
              if (i == 1) {
                ...
                i == mostCorrectAnswers.length - 1 &&
                correctUsers.includes(",")
              ) {
            ...
            embed.addField(
              `Most correct answers: \*${correctCount}\* by \__${correctUsers}\__`,
              `Congrats! :purple_heart:`
            );
